...
class Statstable extends React.Component{
    constructor(props) {
          ...
          render(){
        const {rank, name, team, position, week, fantasypoints, fantasygame, passyards, passtd, passint, rushyards, rushtd, opponent, receptions, recyards, rectd, sacks, defints, forcefum, fumrecovery,} = this.state;
        return(
            <div>
      ...
      <Data name = 'Pat Mahomes' rank ='1' team ='KC Chiefs' week='Week 7' opponent ='49ers' position='QB' fantasypoints='38.5' fantasygame='31.2' passyards='412' passtd='3' passint='1' rushtd='1' rushyards='42'/>
    </Table>
            </div>
        )
    }
